...
export default function Home() {
  ...
  const updateSurveyHandler = () => {
    updateSurvey({ id: surveyData.id, notes: surveyData.notes, created_at: surveyData.created_at })
  }
      ...
      <main className="flex min-h-screen flex-col items-center justify-center">
        {
          !surveyData.id ? (
            ...
            <div className="w-full md:w-2/3 lg:w-1/2 flex flex-col p-5 shadow-2xl gap-5">
              <nav className="fixed top-0 left-0">
                <button
                  aria-label="Leave"
                  onClick={() => tryToLeave()} className="bg-gray-100 p-5 rounded-br-2xl shadow-xl">
                  <BackspaceIcon className="h-8 w-8 text-indigo-600" />
                </button>
              </nav>
              <TextArea
                setNotes={setNotes}
              ...
              <div className="flex flex-col md:flex-row justify-between">
                <button
                  onClick={() => { setNotes(notesStateCache) }}
        ...
        {dangerOpen && (
          <DangerDialog open={dangerOpen} setOpen={setDangerOpen} callback={reset} />
        )}
        <ToastContainer />
      </main>
    </>
